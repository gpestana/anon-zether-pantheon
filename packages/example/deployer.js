        ...
        this.deployZetherVerifier = () => {
            ...
            return new Promise((resolve, reject) => {
                contract
                    ...
                    .on("error", (err) => {
                        reject(err);
                        console.log("deployZetherVerifier")
                    })
                    .on("receipt", (receipt) => {
        ...
        this.deployBurnVerifier = () => {
            ...
            return new Promise((resolve, reject) => {
                contract.deploy({
                    ...
                    .on("error", (err) => {
                        reject(err);
                        console.log("deployBurnVerifier")
                    })
                    .on("receipt", (receipt) => {
